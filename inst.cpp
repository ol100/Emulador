...
int main(int argc, char **argv){
    ...
    char comilla= '"';
    ofstream initfile ("z80ins.js");
    if (initfile.is_open()) {
        //rellenar el fichero
        for (int i = 0; i < 256; i++) {
            initfile << comilla <<  "name"  << comilla<< ": " << comilla<<instructions[i].disassembly << comilla << ",\n" << comilla <<  "type"  << comilla << ": " << comilla << "logic" << comilla << ",\n" <<
             comilla <<  "co"  << comilla<< ": " <<comilla<< "00000000" <<comilla<< ",\n"<<
             comilla <<  "cop"  << comilla<< ": " <<comilla<< "00000000" <<comilla<< ",\n"<<
             comilla <<  "nwords"  << comilla<< ": " << "0" << ",\n"<<
             comilla <<  "signature_definition"  << comilla<< ": " <<comilla<< "F0" <<comilla<< ",\n"<<
             comilla <<  "signature"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n"<<
             comilla <<  "signatureRaw"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ","<<endl;
             //instructions[i].operandLength << " " << instructions[i].execute << endl;
             if(instructions[i].operandLength==0){
                 initfile<< comilla<< "fields"<< ": [\n  "<<
                 "{\n    " <<
                 comilla <<  "name"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
                 comilla <<  "type"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
                 comilla <<  "startbit"  << comilla<< ": " <<comilla<< "0" <<comilla<< ",\n    "<<
                 comilla <<  "stopbit"  << comilla<< ": " <<comilla<< "0" <<comilla<< ",\n    "<<
                 "},\n  "<<
                 "{\n    " <<
                 comilla <<  "name"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
                 comilla <<  "type"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
                 comilla <<  "startbit"  << comilla<< ": " <<comilla<< "0" <<comilla<< ",\n    "<<
                 comilla <<  "stopbit"  << comilla<< ": " <<comilla<< "0" <<comilla<< ",\n    "<<
                 comilla <<  "valuefield"  << comilla<< ": " <<comilla<< "00000000" <<comilla<< ",\n  "<<
                 "},\n"<<
                 "],\n"<<
                 comilla <<  "definition"  << comilla<< ": " <<comilla<< instructions[i].execute <<comilla<< ",\n"<<endl;
             }
             if(instructions[i].operandLength==1){
                 initfile<< comilla<< "fields"<< ": [\n  "<<
                 "{\n    " <<
                 comilla <<  "name"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
                 comilla <<  "type"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
             ...
             if(instructions[i].operandLength==2){
                 initfile<< comilla<< "fields"<< ": [\n  "<<
                 "{\n    " <<
                 comilla <<  "name"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
                 comilla <<  "type"  << comilla<< ": " <<comilla<< instructions[i].disassembly <<comilla<< ",\n    "<<
        ...
        cout << "Error in creating the init file"; //En caso de que no se pueda crear el archivo se muestra un error
        return -1;
    }
