...
int main(int argc, char* argv[])
{
    ...
    while (isRunning)
    {
		...
		if(regist.PC==0x028b)//0x6500////0x264/0x026D/0x0272/0x0281/0x028F/0x0297/0x2a0/0x27A3(CALL)/69DA/0x02A6/0x02C4/0x002D/0x2826/0x282a/0x029a6(donde las scanlines ya van mal)
		{
			//paso=1;
			/*for(int i=0;i<160;i++){
					for(int j=0;j<144;j++){
